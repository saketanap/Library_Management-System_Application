...
String sql= "select count(BorNumber),ReaderID from Borrows,Book where Book.DocID=Borrows.DocID group by Borrows.ReaderID order by count(BorNumber) desc limit 10";
...
userdbName=rs.getString("count(BorNumber)");
